"""
Django settings for monty2020 project.
...
SECRET_KEY = "5b1okp63tf3c#3i^7so(l7bltb1%0jo^9d2uic#!ogutxe7^4&"
...
ALLOWED_HOSTS = ["monty2020.herokuapp.com", "127.0.0.1"]
...
ROOT_URLCONF = "monty2020.urls"
# https://docs.djangoproject.com/en/3.0/ref/settings/#wsgi-application
WSGI_APPLICATION = "monty2020.wsgi.application"
...
# https://docs.djangoproject.com/en/3.0/ref/settings/#email-port
EMAIL_PORT = 1025
